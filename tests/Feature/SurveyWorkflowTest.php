...
class SurveyWorkflowTest extends TestCase
{
    ...
    public function test_authenticated_user_can_render_survey_pages(): void
    {
    ...
    public function test_user_can_store_survey_response(): void
    {
        $user = User::factory()->create();
    ...
    public function test_survey_results_can_be_searched(): void
    {
        $user = User::factory()->create();
    ...
    public function test_report_export_downloads_excel_file(): void
    {
        $user = User::factory()->create();
